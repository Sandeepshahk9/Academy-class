...
if(!empty($_REQUEST['did']) && $_REQUEST['did']!=''){
	...
	mysqli_query($con,"delete from register where id=".$doid);
	echo '<META HTTP-EQUIV="Refresh" Content="0; URL=register_report.php">';
	exit;
}
if(!empty($_REQUEST['upid']) && $_REQUEST['upid']!=''){
    $dovalue="EditRegister";
    $doid=$_REQUEST['upid'];
    $Query=mysqli_query($con,"select * from register where id=$doid");
...
<div class="content-wrapper">
    <section class="content-header">
        <h1> Direct Registeration Form <small></small> </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title"> Registeration Form <small></small></h3>
                        <!-- tools box -->
